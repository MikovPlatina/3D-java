...
Потом уже с помощью fov в радианах (fovRad) и тангенсана мы вычисляем угол лучей в зависимости от растояния от ценра экрана:
...
Потом мы создаем три переменные "направления" луча и нормализируем их так чтобы не искожать скорость лучей:
double dirX = angX;
double dirY = angY;
double dirZ = 1;
